...
class InvitationController extends Controller
{
    ...
    public function accept(Invitation $invitation)
    {
        ...
        // echo $check;
        if ($check == 1) {
            return back()->with('msg', 'daret 3amra.');
        }

        if ($check == 2) {
            return back()->with('msg', 'deja.');
        }

        if ($check == null) {
            return back()->with('msg', 'ajou bien.');
        }
    ...
    public function destroy(Invitation $invitation)
    {
        ...
        return redirect()->route('indexinvit')->with('msg', 'invitation de daret ' . $name . 'est supprimer ');
    }
}
