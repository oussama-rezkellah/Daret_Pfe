...
<body>
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="/admin/darets">Admin</a>
        <!-- Sidebar Toggle-->
        ...
        {{-- <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <div class="input-group">
                <input class="form-control" type="text" id="datatablesSimples" placeholder="Search for..." aria-label="Search for..."
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{route('darets')}}">
                                ...
                                <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <button type="button" data-toggle="modal" data-target="#myModal"
                                         class="nav-link text-black">add Daret</button>
                                   
                                        <a class="nav-link" href="{{route('darets')}}">Darets</a>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    {{-- <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Daret 2023</div>
                        <div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Add Daret</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body">
          <form method="POST" action="{{ route('createDaret') }}">
            @csrf
            ...
            <div class="form-group">
              <label for="test">Type of period</label>
            ...
            <div class="form-group">
              <label for="type_order">Type of order</label>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary">Add Daret</button>
            </div>
          </form>
        </div>
      </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.0/js/bootstrap.min.js" integrity="sha384-71+V3q1HTd20Id6D9KjrrC7V/Y+R6u5eVn5zQKnK/7qjoB1N37BIdXpivGGCg5x5" crossorigin="anonymous"></script>
  ...
  <!-- Inclure la bibliothèque JavaScript de Bootstrap -->
