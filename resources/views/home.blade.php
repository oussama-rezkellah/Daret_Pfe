                                ...
                                <ul class="dropdown-menu notify-drop nav-drop shadow-sm" aria-labelledby="searchDropdown">
                                    ...
                                    <div class="drop-content">
                                        ...
                                        <li class="dropdown-item">
                                            ...
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                                <a href="#" class="notification-user">Argon Social Network <img src="images/theme/verify.png" width="10px" class="verify" alt="Group verified"></a>
                                                <a href="#" class="btn btn-quick-link join-group-btn border text-right float-right">
                                                    Join
                                                </a>
                                    ...
                                    <a class="dropdown-item" href="#">
                                      ...
                                      <form class="inline" method="POST" action="/logout">
                                          ...
                                          <button type="submit">
                                            ...
                                            <img src="images/icons/navbar/logout.png" alt="Navbar icon"> <i class="fa-solid fa-door-closed">log out</i> 
                                          </button>
                                        </form>
                                      @endauth
                        ...
                        <div class="mb-3">
                            <div class="btn-group d-flex">
                                <a href="index.html" class="btn btn-quick-links mr-3 ql-active">
                                    <img src="images/icons/theme/speech.png" class="mr-2" alt="quick links icon">
                                    <span class="fs-8">Speech</span>
                                </a>
                                <a href="messages.html" class="btn btn-quick-links mr-3">
                                    <img src="images/icons/theme/listen.png" class="mr-2" alt="quick links icon">
                                    <span class="fs-8">Listen</span>
                                </a>
                                <a href="watch.html" class="btn btn-quick-links">
                                    <img src="images/icons/theme/watch.png" class="mr-2" alt="quick links icon">
                        ...
                        <div class="posts-section mb-5">
                            <div class="post border-bottom p-3 bg-white w-shadow">
                                <div class="media text-muted pt-3">
                                    <img src="images/users/user-1.jpg" alt="Online user" class="mr-3 post-user-image">
                                                        ...
                                                        <ul class="media-list comments-list">
                                                            <li class="media comment-form">
                                                                <a href="#" class="pull-left">
                                                                    <img src="images/users/user-4.jpg" alt="" class="img-circle">
                                                                </a>
                                                                <div class="media-body">
                            ...
                            <div class="post border-bottom p-3 bg-white w-shadow">
                                <div class="media text-muted pt-3">
                                    <img src="images/users/user-2.jpg" alt="Online user" class="mr-3 post-user-image">
                                    <div class="media-body pb-3 mb-0 small lh-125">
                                        <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div class="post border-bottom p-3 bg-white w-shadow">
                                <div class="media text-muted pt-3">
                                    <img src="images/users/user-4.jpg" alt="Online user" class="mr-3 post-user-image">
                                    <div class="media-body pb-3 mb-0 small lh-125">
                                        <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 pr-3">
                                <div class="media text-muted pr-3 pt-3">
                                    <img src="images/users/user-1.jpg" alt="user image" class="mr-3 post-modal-user-img">
                                    <div class="media-body">
                ...
                <div class="card">
                    <div class="top-bar shadow-sm d-flex align-items-center">
                        <div class="col-md-6 col-xs-6">
                            <a href="profile.html">
                                <img src="images/users/user-2.jpg" class="mr-2 chatbox-user-img" alt="Chat user image">
                                <span class="panel-title">Karen Minas</span>
                            </a>
                        </div>
                        <div class="col-md-6 col-xs-6 d-flex align-items-center justify-content-between">
                            <a href="#">
                                <img src="images/icons/messenger/video-call.png" class="chatbox-call" alt="Chatbox contact types">
                            </a>
                            <a href="#" data-toggle="modal" data-target="#callModal">
                                <img src="images/icons/messenger/call.png" class="chatbox-call" alt="Chatbox contact types">
                            </a>
                        ...
                        <div class="col-md-12 message-box">
                            ...
                            <div class="chat-tools">
                                <a href="#" class="chatbox-tools">
                                    <img src="images/icons/theme/post-image.png" class="chatbox-tools-img" alt="Chatbox tool">
                                </a>
                                <a href="#" class="chatbox-tools">
                                    <img src="images/icons/messenger/gif.png" class="chatbox-tools-img" alt="Chatbox tool">
                                </a>
                                <a href="#" class="chatbox-tools">
                                    <img src="images/icons/messenger/smile.png" class="chatbox-tools-img" alt="Chatbox tool">
                                </a>
                                <a href="#" class="chatbox-tools">
                                    <img src="images/icons/messenger/console.png" class="chatbox-tools-img" alt="Chatbox tool">
                                </a>
                                <a href="#" class="chatbox-tools">
                                    <img src="images/icons/messenger/attach-file.png" class="chatbox-tools-img" alt="Chatbox tool">
                                </a>
                                <a href="#" class="chatbox-tools">
                                    <img src="images/icons/messenger/photo-camera.png" class="chatbox-tools-img" alt="Chatbox tool">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-center">
                            <div class="call-user text-center">
                                <div class="call-user-img-anim">
                                    <img src="images/users/user-1.jpg" class="call-user-img" alt="Call user image">
                                </div>
